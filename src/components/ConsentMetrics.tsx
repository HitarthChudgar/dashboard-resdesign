...
const consentData = [
  { name: "Completed", value: 32, color: "rgb(20, 184, 166)" },
  { name: "Pending", value: 74, color: "rgb(13, 148, 136)" },
];
...
export default function ConsentMetrics() {
  return (
    <div className="h-full">
      <MetricCard
        title="Electronic Consent Collected"
        icon={PenLine}
        completed={32}
        left={74}
        data={consentData}
